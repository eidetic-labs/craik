...
<div><dt>Quality gate view</dt><dt><span className="craik-fields__type">ready in PR</span></dt><dd><a href="https://github.com/eidetic-labs/craik/issues/694">#694</a> · <code>craik operator quality</code> · handoff, evidence, critic, and red-team signals</dd></div>
