...
<div><dt>Memory impact preview</dt><dt><span className="craik-fields__type">ready in PR</span></dt><dd><a href="https://github.com/eidetic-labs/craik/issues/695">#695</a> · <code>craik operator memory-impact</code> · previewed durable-memory effects</dd></div>
