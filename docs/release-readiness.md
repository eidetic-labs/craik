...
<div><dt>G2 migration maps</dt><dt><span className="craik-fields__type">ready after this PR</span></dt><dd><a href="https://github.com/eidetic-labs/craik/issues/828">#828</a> · object-level migration maps classify agents, profiles/personas, provider/model config, aliases, fallback chains, channels, skills, memory, sessions, schedules, sandbox, gateway, and approval/security posture as importable, partial, manual, unsupported, or skipped-secret with explicit target Craik objects and operator actions</dd></div>
<div><dt>G3 migration reports</dt><dt><span className="craik-fields__type">ready after this PR</span></dt><dd><a href="https://github.com/eidetic-labs/craik/issues/826">#826</a> · <code>craik migrate report</code> emits deterministic safe-to-share review artifacts with summary counts, importable objects, manual actions, skipped secrets, security posture changes, unsupported capabilities, recommended next commands, validation checklist items, and source-to-target links without raw secret values</dd></div>
<div><dt>G4 secret migration</dt><dt><span className="craik-fields__type">ready after this PR</span></dt><dd><a href="https://github.com/eidetic-labs/craik/issues/825">#825</a> · secret inventory detects nested secret-like fields without logging values, dry-run receipts write nothing by default, optional keyring import requires operator confirmation and a secure backend, file fallback blocks import, and SECURITY.md documents the trust boundary</dd></div>
<div><dt>G5 compatibility fixture suite</dt><dt><span className="craik-fields__type">ready after this PR</span></dt><dd><a href="https://github.com/eidetic-labs/craik/issues/829">#829</a> · public-safe adjacent-runtime fixtures exercise provider config, fallback chains, profiles/personas, channels, sessions, memory, skills, schedules, sandbox, gateway, approval posture, invalid JSON warnings, and redaction assertions without real operator secrets</dd></div>
<div><dt>G6 MCP server and client compatibility</dt><dt><span className="craik-fields__type">ready after this PR</span></dt><dd><a href="https://github.com/eidetic-labs/craik/issues/831">#831</a> · MCP server compatibility mode exposes safe read tools first, gated write tools require policy and receipts, JSON-RPC smoke handling returns structured denials, and MCP client import/export redacts external config and secret-like environment values</dd></div>
