...
<div><dt>Contradiction inbox</dt><dt><span className="craik-fields__type">ready in PR</span></dt><dd><a href="https://github.com/eidetic-labs/craik/issues/689">#689</a> · <code>craik operator contradictions</code> · contradiction and operator-attention queue</dd></div>
