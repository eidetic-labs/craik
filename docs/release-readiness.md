...
<div><dt>Evidence and assumption views</dt><dt><span className="craik-fields__type">ready in PR</span></dt><dd><a href="https://github.com/eidetic-labs/craik/issues/690">#690</a> · <code>craik operator evidence</code> · evidence and assumptions kept separate</dd></div>
